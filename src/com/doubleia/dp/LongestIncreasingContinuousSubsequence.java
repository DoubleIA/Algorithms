...
public class LongestIncreasingContinuousSubsequence {
	...
	public static void main(String[] args) {
		LongestIncreasingContinuousSubsequence lon = new LongestIncreasingContinuousSubsequence();
		System.out.println(lon.longestIncreasingContinuousSubsequence(new int[]{5, 4, 2, 1, 3}));
	}
}
